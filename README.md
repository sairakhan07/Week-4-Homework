(Continued on from week 3)
WEEK 4 (Data Structures & Collections) 
1. Building on Week 3, create a Module class with attributes (module) name, (module) code. The module name and code should be passed into the constructor. 
